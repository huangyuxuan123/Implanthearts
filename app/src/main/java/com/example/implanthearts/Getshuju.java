...
//                String data2 = data.substring(data.indexOf(":") + 1, data.indexOf("}"));//92
            ...
            //"Temp":28,"Light":0,"Soil":54,"CO2":344,"Humidity":95,"Fan_State":0,"Yellow_Light_State":0,"White_Light_State":0,"Spray_State":0}

            //{ "Temperature": 29, "Illumination_Intensity": 0, "Soil_Humidity": 51, "CO2_Concentration": 760, "Air_Humidity": 52, "Fan_State": 0, "Yellow_Light_State": 0, "White_Light_State": 0, "Sprinkler_State": 0 }

            String[]  t1=data.split(",");
            for(int i=0,len=t1.length;i<len;i++){
                Log.w("rrr","data:"+t1[i].toString());
            }
            ...
            Log.w("rrr","Temp:"+Temp);
            Log.w("rrr","Light:"+Light);
            Log.w("rrr","Soil:"+Soil);
            Log.w("rrr","CO2:"+CO2);
            Log.w("rrr","Humidity:"+Humidity);
